    ...
    statics: {
      ...
      */
      ...
      define: function define(name, config) {
        ...
        config.patch = this.__normalizeArray__P_4_0(config.patch);
        ...
        this.__initializeAliases__P_4_3(theme, config);
      ...
      */
      ...
      __convert__P_4_2: function __convert__P_4_2(theme, config) {
        var type = this.__extractType__P_4_4(config);
...
//# sourceMappingURL=Theme.js.map?dt=1685967534229