    ...
    */
    ...
    members: {
      ...
      getIds: function getIds(pathfragment) {
        var registry = qx.util.ResourceManager.__registry__P_106_0;
        if (!registry) {
          return null;
        }
       ...
       */
      has: function has(id) {
        return !!qx.util.ResourceManager.__registry__P_106_0[id];
      },
      /**
      ...
      getData: function getData(id) {
        return qx.util.ResourceManager.__registry__P_106_0[id] || null;
      },
      /**
      ...
      getImageWidth: function getImageWidth(id) {
        ...
        var entry = qx.util.ResourceManager.__registry__P_106_0[id]; // [ width, height, codepoint ]
        if (size && entry) {
      ...
      getImageHeight: function getImageHeight(id) {
        ...
        var entry = qx.util.ResourceManager.__registry__P_106_0[id];
      ...
      getCombinedFormat: function getCombinedFormat(id) {
        var clippedtype = "";
        var entry = qx.util.ResourceManager.__registry__P_106_0[id];
        var isclipped = entry && entry.length > 4 && typeof entry[4] == "string" && this.constructor.__registry__P_106_0[entry[4]];
        if (isclipped) {
          var combId = entry[4];
          var combImg = this.constructor.__registry__P_106_0[combId];
      ...
      toUri: function toUri(id) {
        ...
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("io.ssl")) {
          urlPrefix = qx.util.ResourceManager.__urlPrefix__P_106_1[lib];
        }
      ...
      toDataUri: function toDataUri(resid) {
        var resentry = this.constructor.__registry__P_106_0[resid];
        var combined = resentry ? this.constructor.__registry__P_106_0[resentry[4]] : null;
        var uri;
        if (combined) {
        ...
        if (qx.core.Environment.get("io.ssl")) {
          for (var lib in qx.$$libraries) {
            ...
            if (qx.util.LibraryManager.getInstance().get(lib, "resourceUri")) {
              ...
              statics.__urlPrefix__P_106_1[lib] = "";
              continue;
            }
            var href;
            ...
            if (resourceUri.match(/^\/\//) != null) {
              statics.__urlPrefix__P_106_1[lib] = window.location.protocol;
            }
            // If the resourceUri begins with a single slash, include the current
            // hostname
            else if (resourceUri.match(/^\//) != null) {
              if (href) {
                statics.__urlPrefix__P_106_1[lib] = href;
              } else {
                statics.__urlPrefix__P_106_1[lib] = window.location.protocol + "//" + window.location.host;
              }
            }
            ...
            // IMPORTANT: this is only applicable for the source version
              ...
              statics.__urlPrefix__P_106_1[lib] = url.substring(0, url.lastIndexOf("/") + 1);
              ...
              statics.__urlPrefix__P_106_1[lib] = href.substring(0, href.lastIndexOf("/") + 1);
            }
          }
        }
      }
...
//# sourceMappingURL=ResourceManager.js.map?dt=1685967544496