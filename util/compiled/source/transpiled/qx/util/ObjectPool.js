  ...
  qx.Class.define("qx.util.ObjectPool", {
    ...
    members: {
      ...
      */
      ...
      getObject: function getObject(clazz) {
        ...
        var obj = null;
        var pool = this.__pool__P_85_0[clazz.classname];
        if (pool) {
          obj = pool.pop();
        }
        if (obj) {
      ...
      poolObject: function poolObject(obj) {
        // Dispose check
        if (!this.__pool__P_85_0) {
          return;
        }
        var classname = obj.classname;
        var pool = this.__pool__P_85_0[classname];
        if (obj.$$pooled) {
          throw new Error("Object is already pooled: " + obj);
        }
        if (!pool) {
          this.__pool__P_85_0[classname] = pool = [];
        }
    ...
    */
    destruct: function destruct() {
      ...
      delete this.__pool__P_85_0;
    }
  });
  qx.util.ObjectPool.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ObjectPool.js.map?dt=1685967543206