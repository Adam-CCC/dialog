  ...
  qx.Class.define("qx.event.handler.DragDrop", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__root__P_82_1 = manager.getWindow().document.documentElement;
      ...
      _onPointermove: function _onPointermove(e) {
        ...
        return qx.event.Utils.then(tracker, function () {
          ...
          qx.event.Utils.then(tracker, function (validAction) {
            ...
            if (el !== cursorEl) {
              var droppable = self.__findDroppable__P_82_19(el);
...
//# sourceMappingURL=DragDrop.js.map?dt=1685967543015