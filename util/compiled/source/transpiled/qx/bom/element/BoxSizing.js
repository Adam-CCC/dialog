  ...
  qx.Bootstrap.define("qx.bom.element.BoxSizing", {
    ...
    */
    ...
    statics: {
       ...
       */
      __usesNativeBorderBox__P_90_1: function __usesNativeBorderBox__P_90_1(element) {
        var map = this.__nativeBorderBox__P_90_0;
      ...
      get: function get(element) {
        ...
        if (qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(element))) {
          if (!this.__usesNativeBorderBox__P_90_1(element)) {
            return "content-box";
          }
        }
        return "border-box";
...
//# sourceMappingURL=BoxSizing.js.map?dt=1685967543541