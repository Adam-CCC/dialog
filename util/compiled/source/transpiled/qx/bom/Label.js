  ...
  qx.Bootstrap.define("qx.bom.Label", {
    ...
    */
    ...
    statics: {
       ...
       */
      __prepareText__P_102_1: function __prepareText__P_102_1() {
        var el = this.__createMeasureElement__P_102_2(false);
       ...
       * @return {Element} Helper DOM element
       */
      __prepareHtml__P_102_3: function __prepareHtml__P_102_3() {
        var el = this.__createMeasureElement__P_102_2(true);
        document.body.insertBefore(el, document.body.firstChild);
       ...
       */
      __createMeasureElement__P_102_2: function __createMeasureElement__P_102_2(html) {
        ...
        if (html) {
          ...
          if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
            ...
            style.margin = "0";
            style.width = "auto";
            for (var key in this.__styles__P_102_0) {
              style[key] = "inherit";
            }
       ...
       */
      __getStyles__P_102_4: function __getStyles__P_102_4(html) {
        var styles = {};
      ...
      create: function create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__getStyles__P_102_4(html));
        }
        if (content) {
      ...
      setSanitizer: function setSanitizer(func) {
        ...
        qx.bom.Label.__sanitizer__P_102_5 = func;
      },
      /**
      ...
      setValue: function setValue(element, value) {
        value = value || "";
        if (element.useHtml) {
          if (qx.bom.Label.__sanitizer__P_102_5 && typeof qx.bom.Label.__sanitizer__P_102_5 === "function") {
            value = qx.bom.Label.__sanitizer__P_102_5(value);
          }
      ...
      getHtmlSize: function getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__prepareHtml__P_102_3();

        // apply width
        element.style.width = width != undefined ? width + "px" : "auto";
        // insert content
        element.innerHTML = content;
        return this.__measureSize__P_102_6(element, styles);
      },
      /**
      ...
      getTextSize: function getTextSize(text, styles) {
        var element = this._textElement || this.__prepareText__P_102_1();
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __measureSize__P_102_6: function __measureSize__P_102_6(element, styles) {
        // sync styles
        var keys = this.__styles__P_102_0;
        if (!styles) {
          styles = {};
        }
        for (var key in keys) {
...
//# sourceMappingURL=Label.js.map?dt=1685967544293