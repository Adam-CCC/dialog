  ...
  qx.Class.define("qx.data.Array", {
    ...
    construct: function construct(param) {
      ...
      if (param == undefined) {
        ...
        this.__array__P_58_0 = new Array(param);
        // check for an array itself
      } else if (param instanceof Array) {
        this.__array__P_58_0 = qx.lang.Array.clone(param);
    ...
    */
    ...
    members: {
      ...
      splice: function splice(startIndex, amount, varargs) {
        ...
        var returnArray = this.__array__P_58_0.splice.apply(this.__array__P_58_0, arguments);
        ...
        this.__updateEventPropagation__P_58_2(startIndex + (arguments.length - 2) - amount, this.length);
      ...
      sort: function sort(func) {
        ...
        var oldArray = this.__array__P_58_0.concat();
        this.__array__P_58_0.sort.apply(this.__array__P_58_0, arguments);
      ...
      setItem: function setItem(index, item) {
        var oldItem = this.__array__P_58_0[index];
        // ignore settings of already set items [BUG #4106]
        if (oldItem === item) {
          return;
        }
        this.__array__P_58_0[index] = item;
      ...
      */
      ...
      removeAll: function removeAll() {
        ...
        var items = this.__array__P_58_0.concat();
      ...
      append: function append(array) {
        ...
        var oldLength = this.__array__P_58_0.length;
        Array.prototype.push.apply(this.__array__P_58_0, array);
...
//# sourceMappingURL=Array.js.map?dt=1685967386443