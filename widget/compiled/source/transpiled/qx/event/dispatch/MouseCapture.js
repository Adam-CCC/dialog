  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.dispatch.MouseCapture", {
    ...
    construct: function construct(manager, registration) {
      ...
      this.__window__P_87_0 = manager.getWindow();
      this.__registration__P_87_1 = registration;
      manager.addListener(this.__window__P_87_0, "blur", this.releaseCapture, this);
      manager.addListener(this.__window__P_87_0, "focus", this.releaseCapture, this);
      manager.addListener(this.__window__P_87_0, "scroll", this.releaseCapture, this);
    },
    statics: {
    ...
    members: {
      __registration__P_87_1: null,
      __captureElement__P_87_2: null,
      __containerCapture__P_87_3: true,
      ...
      */
      ...
      canDispatchEvent: function canDispatchEvent(target, event, type) {
        return !!(this.__captureElement__P_87_2 && this.__captureEvents__P_87_4[type]);
      },
      // overridden
      dispatchEvent: function dispatchEvent(target, event, type) {
        ...
        if (this.__containerCapture__P_87_3 || !qx.dom.Hierarchy.contains(this.__captureElement__P_87_2, target)) {
          target = this.__captureElement__P_87_2;
        }
      ...
      */
      ...
      activateCapture: function activateCapture(element, containerCapture) {
        ...
        if (this.__captureElement__P_87_2 === element && this.__containerCapture__P_87_3 == containerCapture) {
          return;
        }
        if (this.__captureElement__P_87_2) {
          this.releaseCapture();
        }
        ...
        this.__containerCapture__P_87_3 = containerCapture;
        this.__captureElement__P_87_2 = element;
        this.__registration__P_87_1.fireEvent(element, "capture", qx.event.type.Event, [true, false]);
      },
      /**
      ...
      getCaptureElement: function getCaptureElement() {
        return this.__captureElement__P_87_2;
      },
      /**
       * Stop capturing of mouse events.
       */
      releaseCapture: function releaseCapture() {
        var element = this.__captureElement__P_87_2;
        if (!element) {
          return;
        }
        this.__captureElement__P_87_2 = null;
        this.__registration__P_87_1.fireEvent(element, "losecapture", qx.event.type.Event, [true, false]);
...
//# sourceMappingURL=MouseCapture.js.map?dt=1685967389494