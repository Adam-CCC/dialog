  ...
  qx.Class.define("qx.event.handler.Touch", {
    ...
    */
    ...
    construct: function construct(manager) {
      // Define shorthands
      this.__manager__P_145_0 = manager;
      this.__window__P_145_1 = manager.getWindow();
      this.__root__P_145_2 = this.__window__P_145_1.document;
      qx.event.handler.TouchCore.apply(this, [this.__root__P_145_2]);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    members: {
      __manager__P_145_0: null,
      __window__P_145_1: null,
      __root__P_145_2: null,
      // Checks if the mouse movement is happening while simulating a touch event
      __isInTouch__P_145_3: false,
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _fireEvent: function _fireEvent(domEvent, type, target, eventTypeClass) {
        ...
        qx.event.Registration.fireEvent(this.__window__P_145_1, "useraction", qx.event.type.Data, [type]);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      dispose: function dispose() {
        this.__callBase__P_145_4("dispose");
        this.__manager__P_145_0 = this.__window__P_145_1 = this.__root__P_145_2 = null;
      },
      /**
       ...
       */
      __callBase__P_145_4: function __callBase__P_145_4(method, args) {
...
//# sourceMappingURL=Touch.js.map?dt=1685967395999