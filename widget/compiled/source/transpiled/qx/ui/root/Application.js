  ...
  qx.Class.define("qx.ui.root.Application", {
    ...
    */
    ...
    construct: function construct(doc) {
      ...
      this.__doc__P_12_1 = doc;

      // Base call
      qx.ui.root.Abstract.constructor.call(this);

      // Resize handling
      qx.event.Registration.addListener(this.__window__P_12_0, "resize", this._onResize, this);
      ...
      this.addListener("touchmove", this.__stopScrolling__P_12_2, this);
...
//# sourceMappingURL=Application.js.map?dt=1685967378592