  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.HBox", {
    ...
    */
    ...
    members: {
      __widths__P_114_0: null,
      __flexs__P_114_1: null,
      __enableFlex__P_114_2: null,
      __children__P_114_3: null,
      /*
      ---------------------------------------------------------------------------
        HELPER METHODS
      ---------------------------------------------------------------------------
      */
       ...
       */
      __rebuildCache__P_114_4: function __rebuildCache__P_114_4() {
        var children = this._getLayoutChildren();
        var length = children.length;
        var enableFlex = false;
        var reuse = this.__widths__P_114_0 && this.__widths__P_114_0.length != length && this.__flexs__P_114_1 && this.__widths__P_114_0;
        var props;

        // Sparse array (keep old one if lengths has not been modified)
        var widths = reuse ? this.__widths__P_114_0 : new Array(length);
        var flexs = reuse ? this.__flexs__P_114_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__widths__P_114_0 = widths;
          this.__flexs__P_114_1 = flexs;
        }
        this.__enableFlex__P_114_2 = enableFlex;
        this.__children__P_114_3 = children;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this._invalidChildrenCache) {
          this.__rebuildCache__P_114_4();
        }

        // Cache children
        var children = this.__children__P_114_3;
        var length = children.length;
        ...
        for (i = 0; i < length; i += 1) {
          percent = this.__widths__P_114_0[i];
        ...
        if (this.__enableFlex__P_114_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
          var notEnoughSpace = allocatedWidth > availWidth;
          for (i = 0; i < length; i += 1) {
            flex = this.__flexs__P_114_1[i];
            if (flex > 0) {
              hint = children[i].getSizeHint();
              flexibles[i] = {
                min: hint.minWidth,
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__flexs__P_114_1[i];
          var percent = this.__widths__P_114_0[i];
          if (flex) {
    ...
    */
    destruct: function destruct() {
      this.__widths__P_114_0 = this.__flexs__P_114_1 = this.__children__P_114_3 = null;
    }
  });
  qx.ui.layout.HBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=HBox.js.map?dt=1685967392700