  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      // Register events
      qx.event.Registration.addListener(document.body, "pointerover", this.__onPointerOverRoot__P_31_0, this, true);
      ...
      this.__hideTimer__P_31_3.addListener("interval", this.__onHideInterval__P_31_4, this);
    ...
    members: {
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__showTimer__P_31_1.startWith(value.getShowTimeout());
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__onPointerOverRoot__P_31_0, this, true);
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Css", {
    statics: {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementHeight = qx.module.Css.__swap__P_139_0(elem, stylesToSwap, "_getHeight", this);
            } else {
        ...
        if (elem) {
          if (qx.dom.Node.isElement(elem)) {
            ...
            if (force) {
              ...
              elementWidth = qx.module.Css.__swap__P_139_0(elem, stylesToSwap, "_getWidth", this);
            } else {
      ...
      _getContentHeight: function _getContentHeight(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentHeight = qx.module.Css.__swap__P_139_0(obj, stylesToSwap, "_getContentHeight", this);
          } else {
      ...
      _getContentWidth: function _getContentWidth(force) {
        ...
        if (qx.dom.Node.isElement(obj)) {
          ...
          if (force) {
            ...
            contentWidth = qx.module.Css.__swap__P_139_0(obj, stylesToSwap, "_getContentWidth", this);
          } else {
       ...
       * or <code>block</code>
       */
      __getDisplayDefault__P_139_2: function __getDisplayDefault__P_139_2(tagName, doc) {
        var defaults = qx.module.Css.__displayDefaults__P_139_1;
        if (!defaults[tagName]) {
       ...
       */
      __swap__P_139_0: function __swap__P_139_0(element, styles, methodName, context) {
        ...
        this._forEachElementWrapped(function (item) {
          ...
          if (currentVal == "none") {
            if (prevVal && prevVal != "none") {
              ...
              newVal = qx.module.Css.__getDisplayDefault__P_139_2(item[0].tagName, doc);
            }
...
//# sourceMappingURL=package-3.js.map?dt=1685967401879
qx.$$packageData['3'] = {
  "locales": {},
  "resources": {},
  "translations": {}
