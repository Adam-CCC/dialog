  ...
  qx.Bootstrap.define("qxWeb", {
    ...
    statics: {
      ...
      $init: function $init(arg, clazz) {
        ...
        for (var i = 0; i < qxWeb.__init__P_162_0.length; i++) {
          qxWeb.__init__P_162_0[i].call(col);
        }
        return col;
      },
      /**
      ...
      $attachInit: function $attachInit(init) {
        this.__init__P_162_0.push(init);
      },
      /**
...
//# sourceMappingURL=qxWeb.js.map?dt=1686131262679