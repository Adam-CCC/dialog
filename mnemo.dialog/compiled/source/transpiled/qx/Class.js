    ...
    statics: {
      ...
      */
      ...
      __defineImpl__P_2_1: function __defineImpl__P_2_1(name, config) {
        ...
        // Create the class
        var clazz = this.__createClass__P_2_3(name, config.type, config.extend, config.statics, config.construct, config.destruct, config.include);
      ...
      __createClass__P_2_3: function __createClass__P_2_3(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            clazz = this.__wrapConstructor__P_2_14(construct, name, type);
...
//# sourceMappingURL=Class.js.map?dt=1686131240716