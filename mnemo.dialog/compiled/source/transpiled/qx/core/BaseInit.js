    ...
    */
    ...
    statics: {
      ...
      getApplication: function getApplication() {
        return this.__application__P_36_0 || null;
      },
      /**
      ...
      ready: function ready() {
        ...
        if (clazz) {
          this.__application__P_36_0 = new clazz();
          var start = new Date();
          this.__application__P_36_0.main();
          if (qx.core.Environment.get("qx.debug.startupTimings")) {
            qx.log.Logger.debug(this, "Main runtime: " + (new Date() - start) + "ms");
          }
          var start = new Date();
          this.__application__P_36_0.finalize();
          if (qx.core.Environment.get("qx.debug.startupTimings")) {
       ...
       */
      __close__P_36_1: function __close__P_36_1(e) {
        var app = this.__application__P_36_0;
        if (app) {
          app.close();
        }
      },
       ...
       *
       */
      __shutdown__P_36_2: function __shutdown__P_36_2() {
        var app = this.__application__P_36_0;
        if (app) {
          app.terminate();
        }
...
//# sourceMappingURL=BaseInit.js.map?dt=1686131247815