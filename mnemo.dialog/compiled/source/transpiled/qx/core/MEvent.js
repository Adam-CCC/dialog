  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __Registration__P_89_0: qx.event.Registration,
      /**
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__Registration__P_89_0.addListener(this, type, listener, self, capture);
        }
        return null;
      },
      /**
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__Registration__P_89_0.removeListener(this, type, listener, self, capture);
        }
        return false;
      },
      /**
      ...
      removeListenerById: function removeListenerById(id) {
        if (!this.$$disposed) {
          return this.__Registration__P_89_0.removeListenerById(this, id);
        }
        return false;
      },
      /**
      ...
      hasListener: function hasListener(type, capture) {
        return this.__Registration__P_89_0.hasListener(this, type, capture);
      },
      /**
       ...
       */
      __trackPendingEvent__P_89_3: function __trackPendingEvent__P_89_3(result) {
        var _this = this;
        {
          if (!qx.Promise.isPromise(result)) {
            return result;
          }
          if (!this.__pendingEvents__P_89_1) {
            this.__pendingEvents__P_89_1 = {};
          }
          ...
          var newPromise = result.then(function (result) {
            delete _this.__pendingEvents__P_89_1[hashCode];
            var promise = _this.__promiseWaitForPendingEvents__P_89_2;
            if (promise && Object.keys(_this.__pendingEvents__P_89_1).length == 0) {
              _this.__pendingEvents__P_89_1 = null;
              _this.__promiseWaitForPendingEvents__P_89_2 = null;
              promise.resolve();
            }
            return result;
          })["catch"](function (err) {
          ...
          this.__pendingEvents__P_89_1[hashCode] = newPromise;
          return newPromise;
        }
      },
      /**
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                if (_this2.__pendingEvents__P_89_1) {
                  _context.next = 2;
                  break;
                }
                return _context.abrupt("return");
              case 2:
                if (!_this2.__promiseWaitForPendingEvents__P_89_2) {
                  _this2.__promiseWaitForPendingEvents__P_89_2 = new qx.Promise();
                }
                promise = _this2.__promiseWaitForPendingEvents__P_89_2;
                _context.next = 6;
                return promise;
              case 6:
              case "end":
      ...
      fireEvent: function fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__trackPendingEvent__P_89_3(this.__Registration__P_89_0.fireEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireEventAsync: function fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__trackPendingEvent__P_89_3(this.__Registration__P_89_0.fireEventAsync(this, type, clazz, args));
        }
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__trackPendingEvent__P_89_3(this.__Registration__P_89_0.fireNonBubblingEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireNonBubblingEventAsync: function fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__trackPendingEvent__P_89_3(this.__Registration__P_89_0.fireNonBubblingEventAsync(this, type, clazz, args));
        }
        return qx.Promise.resolve(true);
      },
      /**
      ...
      fireDataEvent: function fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__trackPendingEvent__P_89_3(this.__Registration__P_89_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return true;
      },
      /**
      ...
      fireDataEventAsync: function fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__trackPendingEvent__P_89_3(this.__Registration__P_89_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return qx.Promise.resolve(true);
      }
    }
...
//# sourceMappingURL=MEvent.js.map?dt=1686131254976