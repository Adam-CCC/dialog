  ...
  qx.Class.define("qx.core.Init", {
    ...
    */
    ...
    statics: {
       ...
       */
      __close__P_12_0: function __close__P_12_0(e) {
       ...
       *
       */
      __shutdown__P_12_1: function __shutdown__P_12_1() {
        var app = this.getApplication();
        if (app) {
          app.terminate();
        }
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "shutdown", statics.__shutdown__P_12_1, statics);
      qx.event.Registration.addListener(window, "beforeunload", statics.__close__P_12_0, statics);
    }
  });
  qx.core.Init.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Init.js.map?dt=1686131243020