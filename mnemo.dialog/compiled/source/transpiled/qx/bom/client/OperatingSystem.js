  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
      ...
      getVersion: function getVersion() {
        var version = qx.bom.client.OperatingSystem.__getVersionForDesktopOs__P_44_1(navigator.userAgent);
        if (version == null) {
          version = qx.bom.client.OperatingSystem.__getVersionForMobileOs__P_44_2(navigator.userAgent);
        }
        if (version != null) {
          return version;
        } else {
       ...
       */
      __getVersionForDesktopOs__P_44_1: function __getVersionForDesktopOs__P_44_1(userAgent) {
        var str = [];
        for (var key in qx.bom.client.OperatingSystem.__ids__P_44_0) {
          str.push(key);
        }
        var reg = new RegExp("(" + str.join("|").replace(/\./g, ".") + ")", "g");
        var match = reg.exec(userAgent);
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__ids__P_44_0[match[1]];
        }
        return null;
      },
      /**
       ...
       * @return {String} version number as string or null.
       */
      __getVersionForMobileOs__P_44_2: function __getVersionForMobileOs__P_44_2(userAgent) {
...
//# sourceMappingURL=OperatingSystem.js.map?dt=1686131248894